...
#icon
image_icon=PhotoImage(file="img/hidden1.png.png")
...
Label(root,text="CYBER SCIENCE",bg="#2d4155",fg="white",font="Poppins 25 bold").place(x=100,y=20)
...
Button(f3,text="Open Image",width=10,height=2,font="Poppins 14 bold",command=showimage).place(x=20,y=30)
Button(f3,text="Save Image",width=10,height=2,font="Poppins 14 bold",command=save).place(x=180,y=30)
...
Button(f4,text="Hide Data",width=10,height=2,font="Poppins 14 bold",command=Hide).place(x=20,y=30)
Button(f4,text="Show Data",width=10,height=2,font="Poppins 14 bold",command=Show).place(x=180,y=30)
